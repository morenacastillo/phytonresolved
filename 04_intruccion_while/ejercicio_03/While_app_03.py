...
class App(customtkinter.CTk):
    ...
    def btn_pedir_clave_on_click(self):
        clave = prompt("Contraseña", "Ingrese su contraseña")
        clave_valida = "utn750"

        while clave == clave_valida:
            alert("Bienvenido", "Has ingresado correctamente tu clave")
            break
        while clave != clave_valida:
            alert("Incorrecto", "No has ingresado correctamente tu clave")
            break
